...
public class Program extends Application implements EventHandler<Event> {
    ...
    private int thread1_priority = 1;
    private int thread2_priority = 1;
    ...
    public void start(Stage stage) {
        ...
        Label center_title = new Label("*** Control Panel ***");

        Label thread_labelThread_1 = new Label("1-st thread: ");
        ...
        thread_box1.getChildren().addAll(thread_labelThread_1, thread1_up, thread1_down, thread1_value_label);
        thread_box1.setAlignment(Pos.TOP_CENTER);
        thread_box1.setSpacing(10);

        Label thread_labelThread_2 = new Label("2-nd thread: ");
        ...
        thread_box2.getChildren().addAll(thread_labelThread_2, thread2_up, thread2_down, thread2_value_label);
    ...
    public void handle(Event event) {
        if        (event.getSource() == start_button) {
            AbleButtons();
            thread1 = new MyThread(true, "thread1");
            thread2 = new MyThread(false, "thread2");
            ...
            if (thread1_priority < Thread.MAX_PRIORITY) {
                ...
                System.out.println("thread " + thread1.name + " ( " + thread1.up + " )" + " priority = " + thread1.getPriority());
            }
            ...
            if (thread2_priority < Thread.MAX_PRIORITY) {
                ...
                System.out.println("thread " + thread2.name + " (" + thread2.up + " )" + " priority = " + thread2.getPriority());
            }
    ...
    private void DisableButton() {
        ...
        thread1_value_label.setText("1");
        thread2_value_label.setText("1");
        thread1_priority = 1;
        thread2_priority = 1;
    }
